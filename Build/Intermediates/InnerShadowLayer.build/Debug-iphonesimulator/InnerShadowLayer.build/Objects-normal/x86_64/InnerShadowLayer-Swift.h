...
SWIFT_CLASS("_TtC16InnerShadowLayer11AppDelegate")
...
SWIFT_CLASS("_TtC16InnerShadowLayer16InnerShadowLayer")
...
@interface UIColor (SWIFT_EXTENSION(InnerShadowLayer))
+ (UIColor * __nonnull)hexColor:(NSInteger)color;
+ (UIImage * __nonnull)makeImageWithColor:(UIColor * __nonnull)color size:(CGSize)size;
@end

@class NSBundle;

SWIFT_CLASS("_TtC16InnerShadowLayer14ViewController")
